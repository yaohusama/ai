...
class FS_window(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):#初始化，没有父类
        ...
        self.button_classify.clicked.connect(self.adaboost_classify)
    ...
    def get_picture(self):
        try:
            img=cv2.imdecode(np.fromfile(self.img,dtype=np.uint8),-1)#不能直接读取中文路径，要记住
            # print(type(self.img))
            # print(img)
    ...
    def color_moment(self):
        try:
            ...
            self.color_feature.extend([h_std, s_std, v_std])
            ...
            self.lineEdit_H_first.setText(str(self.color_feature[0]))
            self.lineEdit_H_second.setText(str(self.color_feature[1]))            
            self.lineEdit_H_third.setText(str(self.color_feature[2]))
            self.lineEdit_S_first.setText(str(self.color_feature[3]))  
            self.lineEdit_S_second.setText(str(self.color_feature[4]))    
            self.lineEdit_S_third.setText(str(self.color_feature[5]))
            self.lineEdit_V_first.setText(str(self.color_feature[6]))            
            self.lineEdit_V_second.setText(str(self.color_feature[7]))
            self.lineEdit_V_third.setText(str(self.color_feature[8])) 
        except:
    ...
    def Hu_invariant_moment(self):
        try:
            ...
            self.humoments=self.humoments.tolist()
            self.humoments=sum(self.humoments, [])
                
            self.fai_1.setText(str(self.humoments[0]))
            self.fai_2.setText(str(self.humoments[1]))         
            self.fai_3.setText(str(self.humoments[2]))
            self.fai_4.setText(str(self.humoments[3]))
            self.fai_5.setText(str(self.humoments[4]))   
            self.fai_6.setText(str(self.humoments[5]))
            self.fai_7.setText(str(self.humoments[6]))         


        except:
            QMessageBox.information(self, 'Warning', '提取Hu矩出错', QMessageBox.Ok)
    ...
    def adaboost_classifier(self):
        try:
            ...
            self.classify_result=predictions
        except:
    ...
    def adaboost_classify(self):         
            self.classification_result.setText(str(self.classify_result))        
