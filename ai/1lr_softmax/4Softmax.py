...
class Softmax(object):
    ...
    def __init__(self):
        self.learning_step = 0.0000001           # 学习速率
        self.max_iteration = 70000             # 最大迭代次数
        self.weight_lambda = 0.001             # 衰退权重
    ...
    def cal_partial_derivative(self,x,y,j):
        ...
        #-x*(first-first*second) + self.weight_lambda*self.w[j]
        #return -x*(first-second) + self.weight_lambda*self.w[j]
        return -x*first*(1-second) + self.weight_lambda*self.w[j]
